        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {user && (
              <Link
                to={`/profile/${user._id}`}
                className="inline-flex h-10 items-center justify-center rounded-lg border border-indigo-600 px-5 text-indigo-600 transition hover:bg-indigo-50"
              >
                My Profile
              </Link>
            )}
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg bg-red-500 px-5 text-white transition hover:bg-red-600"
            >
              Logout
            </button>
