...
const { getAllUsers,blockUser,unblockUser,deleteUser,deleteSnippet,deleteComment,getAdminDashboard,getAllAdminSnippets,getAllAdminComments } = require("../controllers/adminController");
...
router.get("/comments",protect,adminOnly,getAllAdminComments);
